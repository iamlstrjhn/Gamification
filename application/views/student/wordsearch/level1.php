...
*/
body {
	background: url("images/bg-map-01.jpg") no-repeat center center fixed;
...
<body>
    <div class="container">
			...
			<div class="puzzleWrap">
				...
				<h3 style=" font-weight: 300; color: white; margin: 0 40px;">Wordsearch Level 1 &ensp;
			    <a href="<?php echo base_url('word-search-category') ?>" id="solve" style="margin-top: 40px!important; text-decoration: none;">Go back</a></h3> 
			
			  <div id='puzzle'></div>
			  <div id='words'>
			    <button id='solve' style="margin-top: 40px;">Solve Puzzle</button>
...
$(function () {
  var words = ['ALYANSA', 'GENOCIDE', 'COLDWAR', 'FASCISM', 'GLASNOST', 'AXIS', 'ARMISTICE', 'IMPERYAL', 'DEMOKRASYA', 'ALLIED', 'value', 'index'];
