		...
		<center>
			...
			<div class="container">
				<div class="card card-custom">
						<form action="<?php echo base_url('Register/register_faculty_account') ?>" method="post">
							<p class="h6-caption">CREATE ACCOUNT FOR FACULTY</p>
			                    ...
			                    <p class="h6-login-need-account">Already have? <a href="<?php echo base_url('login-faculty'); ?>" style="font-weight: 600; color: red ;">GO BACK</a></p> 
						</form>
