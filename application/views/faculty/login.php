		...
		<center>
			...
			<div class="container">
				<div class="card-custom">
						<form action="<?php echo base_url('Login/login_account_faculty') ?>" method="post">
							<p class="h6-caption">ENTER ACCOUNT FOR FACULTY</p>
			                    ...
			                    <p class="h6-login-need-account">Need an account? <a href="<?php echo base_url ('register-faculty'); ?>" style="font-weight: 600; color: #9c7185 ;">CLICK HERE</a></p> 
						</form>
